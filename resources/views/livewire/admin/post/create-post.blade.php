        ...
        <div class="grid grid-cols-8 gap-3">
            <div class="col-span-6 px-4 py-3 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <label class="block text-sm">
                    ...
                    @error('title') <span class="text-xs font-semibold text-red-600 dark:text-red-400">{{ $message }}</span>
                    <br> @enderror
                ...
                <x-rich-editor wire:model="content" id="content"></x-rich-editor>
            ...
            <div class="col-span-2 px-4 py-3 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <p class="font-bold my-3">Select A category</p>
                <div class="flex flex-col">
                    <x-blog.categories-tree-view :parent-categories="$parentCategories" calling-place="show-tree"></x-blog.categories-tree-view>
