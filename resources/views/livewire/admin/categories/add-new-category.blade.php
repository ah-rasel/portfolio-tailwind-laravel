    ...
    <form wire:submit.prevent="AddCategory()" action="" method="POST" class="mt-4">
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <label class="block mt-4 text-sm" for="description">
                <span class="font-semibold text-gray-700 dark:text-gray-400">Category Description</span>
                <x-rich-editor wire:model="description" id="description"></x-rich-editor>
                @error('description') <span class="text-xs font-semibold text-red-600 dark:text-red-400">{{ $message }}</span>
                <br> @enderror
            </label>
